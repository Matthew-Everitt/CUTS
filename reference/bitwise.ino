...
void setup(){
  ...
  /*Use carrierTimer to detect the absense of a carrier, which would allow us to go into sleep mode, or whatever*/
  carrierTimer.initialize(833*50); /*Delay in microseconds - 833 microseconds is the londest perios (1/1200Hz), so 50 times that is a reasonable number of events not happening*/
